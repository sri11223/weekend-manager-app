// src/types/theme.ts - COMPLETE THEME DEFINITIONS
...
// ✅ ALL THEMES FROM MOCK DATA WITH PERFECT COLOR SCHEMES
export const MOOD_THEMES: MoodTheme[] = [
  {
    ...
    categories: ['outdoor', 'sports', 'travel', 'games', 'food', 'social']
  },
  {
    id: 'relaxed',
    name: 'Calm & Peaceful',
    ...
    categories: ['wellness', 'nature', 'books', 'movies', 'food', 'art']
  },
  {
    id: 'energetic',
    ...
    categories: ['sports', 'social', 'outdoor', 'games', 'music', 'dance']
  },
  {
    id: 'romantic',
    name: 'Romantic Mood',
    ...
    categories: ['food', 'movies', 'outdoor', 'culture', 'wellness', 'travel']
  },
  {
    id: 'focus',
    name: 'Focus Mode',
    ...
    description: 'Clean and minimal for productivity',
    categories: ['meditation', 'study', 'brain_training', 'environment', 'reading', 'writing']
  },
  {
    id: 'creative_flow',
    name: 'Creative Flow',
    ...
    categories: ['visual_arts', 'music', 'writing', 'movement', 'crafts', 'digital_creation', 'performance']
  }
]
